...
public abstract class BlockTriniaLog extends BlockRotatedPillar
{
    public static final PropertyEnum LOG_AXIS = PropertyEnum.create("axis", BlockTriniaLog.EnumAxis.class);
    private static final String __OBFID = "CL_00000266";

    public BlockTriniaLog()
    {
        super(Material.wood);
    ...
    {
        return super.onBlockPlaced(worldIn, pos, facing, hitX, hitY, hitZ, meta, placer).withProperty(LOG_AXIS, BlockTriniaLog.EnumAxis.fromFacingAxis(facing.getAxis()));
    }
    ...
    public static enum EnumAxis implements IStringSerializable
    {
        ...
        public static BlockTriniaLog.EnumAxis fromFacingAxis(EnumFacing.Axis axis)
        {
            switch (BlockTriniaLog.SwitchAxis.AXIS_LOOKUP[axis.ordinal()])
            {
                case 1:
                    return X;
                case 2:
