...
public class EntityPapertazerLayer implements LayerRenderer
{
    private final RenderPlayer field_177208_a;
    private static final String __OBFID = "CL_00002421";

    public EntityPapertazerLayer(RenderPlayer p_i46119_1_)
    {
    ...
    {
        if (p_177207_1_.getName().equals("papertazer") && p_177207_1_.hasSkin() && !p_177207_1_.isInvisible())
        {
