...
public class TriniaEntities {
	...
	public static void loadEntities() {
		...
		EntityRegistry.registerGlobalEntityID(EntityMermaid.class, "mermaid",
				entityID);
		EntityRegistry.registerGlobalEntityID(EntityBlemmyae.class, "blemmyae",
				entityID2);
		EntityRegistry.registerGlobalEntityID(EntityIceDragon.class,
				"icedragon", entityID3);
		EntityRegistry.registerGlobalEntityID(EntityRedDragon.class,
				"reddragon", entityID4);
		EntityRegistry.registerGlobalEntityID(EntityTownsmen.class, "townsmen",
				entityID5);
		EntityRegistry.registerGlobalEntityID(EntityTownswoman.class,
				"townswoman", entityID6);
		EntityRegistry.registerGlobalEntityID(EntityAngelBoss.class,
				"angelboss", entityID7);
		EntityRegistry.registerGlobalEntityID(EntityButterfly.class,
				"butterfly", entityID8);
		EntityRegistry.registerGlobalEntityID(EntityCentaur.class, "centaur",
				entityID9);
		...
		EntityList.entityEggs.put(Integer.valueOf(entityID),
				new EntityList.EntityEggInfo(entityID, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID2),
				new EntityList.EntityEggInfo(entityID2, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID3),
				new EntityList.EntityEggInfo(entityID3, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID4),
				new EntityList.EntityEggInfo(entityID4, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID5),
				new EntityList.EntityEggInfo(entityID5, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID6),
				new EntityList.EntityEggInfo(entityID6, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID7),
				new EntityList.EntityEggInfo(entityID7, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID8),
				new EntityList.EntityEggInfo(entityID8, (0 << 16) + (255 << 8)
						+ 255, (0 << 16) + (0 << 8) + 204));
		EntityList.entityEggs.put(Integer.valueOf(entityID9),
