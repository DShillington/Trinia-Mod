...
public class BiomeGenTrinia extends BiomeGenBase
{
    ...
    public BiomeGenTrinia(int p_i45373_1_, boolean p_i45373_2_)
    {
        super(p_i45373_1_);
     ...
     */
    public BiomeGenTrinia mutateHills(BiomeGenBase p_150633_1_)
    {
    ...
    {
        return (new BiomeGenTrinia(p_180277_1_, false)).mutateHills(this);
    }
}
