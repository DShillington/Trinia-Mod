...
public class WorldGenRedTree extends WorldGenAbstractTree
{
    ...
    public WorldGenRedTree(boolean p_i2008_1_)
    {
        super(p_i2008_1_);
    ...
    void generateLeafNodeList()
    {
        ...
        this.field_175948_j.add(new WorldGenRedTree.FoliageCoordinates(this.field_175947_m.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.func_175936_a(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.field_175948_j.add(new WorldGenRedTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void func_175941_b()
    {
        ...
        {
            WorldGenRedTree.FoliageCoordinates foliagecoordinates = (WorldGenRedTree.FoliageCoordinates)iterator.next();
