...
public class BlockCompressor extends BlockTrinia {
	...
	public static void setState(World worldIn, BlockPos pos, Block setter)
    {
        ...
        worldIn.setBlockState(pos, setter.getDefaultState().withProperty(BlockCompressor.FACING, iblockstate.getValue(BlockCompressor.FACING)), 3);
        worldIn.setBlockState(pos, setter.getDefaultState().withProperty(BlockCompressor.FACING, iblockstate.getValue(BlockCompressor.FACING)), 3);
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(TriniaBlocks.compressor);
	}
}