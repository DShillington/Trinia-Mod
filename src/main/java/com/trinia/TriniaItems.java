...
import com.trinia.init.ItemSteelArmor;
import com.trinia.init.ItemSteelAxe;
import com.trinia.init.ItemSteelHammer;
import com.trinia.init.ItemSteelPickaxe;
import com.trinia.init.ItemSteelSpade;
import com.trinia.init.ItemSteelSword;
import com.trinia.init.ItemTimeMachine;
import com.trinia.init.ItemTrinia;
...
public class TriniaItems {
	...
	*/
	...
	public static ArmorMaterial TriniaSteelArmor = EnumHelper.addArmorMaterial("Steel", "Steel", 30, new int[] {3, 8, 6, 3}, 20);
	//-Weapons-
	//Steel
	...
	//Molten Buckets
	public static Item moltenSteel;
	public static Item moltenTin;
	...
	public static void init()
	{
		...
		Polearm = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("polearm").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Warhammer = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Warhammer").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Wand = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Wand").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Sickle = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Sickle").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Parasol = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Parasol").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Bastard_Sword = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Bastard_Sword").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Quivver = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Quivver").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Staff = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Staff").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Battle_Axe = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Battle_Axe").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Mace = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Mace").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Ring_Sword = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Ring_Sword").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Dagger = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Dagger").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Nunchucks = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Nunchucks").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Katar = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Katar").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Sai = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Sai").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Katana = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Katana").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Swallow = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Swallow").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Scythe = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Scythe").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Tonfa = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Tonfa").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Maul = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Maul").setCreativeTab(TriniaMod.TriniaMedievalTab));
		Halberd = (new ItemSteelPickaxe(null, TriniaSteel).setUnlocalizedName("Halberd").setCreativeTab(TriniaMod.TriniaMedievalTab));
		//Random Items
		...
		//Molten
		moltenSteel = (new ItemTrinia().setUnlocalizedName("moltenSteel")).setCreativeTab(TriniaMod.TriniaMainTab);
	...
	public static void register()
	{
		...
		//Molten
		GameRegistry.registerItem(moltenSteel, moltenSteel.getUnlocalizedName().substring(5));
		GameRegistry.registerItem(moltenSilver, moltenSilver.getUnlocalizedName().substring(5));
		GameRegistry.registerItem(moltenTin, moltenTin.getUnlocalizedName().substring(5));
		GameRegistry.registerItem(moltenCopper, moltenCopper.getUnlocalizedName().substring(5));
		//-Tools-
		//Steel
	...
	public static void registerRenders()
	{
		...
		//Molten
		registerRender(moltenSteel);
		registerRender(moltenSilver);
		registerRender(moltenTin);
		registerRender(moltenCopper);
		//-Tools-
		//Steel
