...
public class EntityMermaid extends EntityMob
{
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn)
    {
        ...
        if ((this.worldObj.getDifficulty() == EnumDifficulty.NORMAL || this.worldObj.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager)
        {
            ...
            EntityMermaid entityzombie = new EntityMermaid(this.worldObj);
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_)
    {
        ...
        {
            p_180482_2_1 = new EntityMermaid.GroupData(this.worldObj.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_180482_2_1 instanceof EntityMermaid.GroupData)
        {
            EntityMermaid.GroupData groupdata = (EntityMermaid.GroupData)p_180482_2_1;
