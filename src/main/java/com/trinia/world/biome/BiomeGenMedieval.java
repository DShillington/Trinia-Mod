...
public class BiomeGenMedieval extends BiomeGenBase
{
    protected boolean field_150628_aC;
    private static final String __OBFID = "CL_00000180";

    public BiomeGenMedieval(int p_i1986_1_)
    {
        super(p_i1986_1_);
    ...
    {
        BiomeGenMedieval biomegenplains = new BiomeGenMedieval(p_180277_1_);
