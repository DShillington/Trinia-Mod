...
public class EntityBlemmyae extends EntityMob
{
    ...
    public EntityBlemmyae(World worldIn)
    {
        super(worldIn);
    ...
    {
    	this.tasks.addTask(4, new EntityAIAttackOnCollide(this, EntityPig.class, 1.0D, true));
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn)
    {
        ...
        if ((this.worldObj.getDifficulty() == EnumDifficulty.NORMAL || this.worldObj.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager)
        {
            ...
            EntityBlemmyae entityzombie = new EntityBlemmyae(this.worldObj);
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_)
    {
        ...
        {
            p_180482_2_1 = new EntityBlemmyae.GroupData(this.worldObj.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_180482_2_1 instanceof EntityBlemmyae.GroupData)
        {
            EntityBlemmyae.GroupData groupdata = (EntityBlemmyae.GroupData)p_180482_2_1;
