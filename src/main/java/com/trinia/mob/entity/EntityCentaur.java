...
public class EntityCentaur extends EntityMob
{
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn)
    {
        ...
        if ((this.worldObj.getDifficulty() == EnumDifficulty.NORMAL || this.worldObj.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager)
        {
            ...
            EntityCentaur entityzombie = new EntityCentaur(this.worldObj);
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_)
    {
        ...
        {
            p_180482_2_1 = new EntityCentaur.GroupData(this.worldObj.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_180482_2_1 instanceof EntityCentaur.GroupData)
        {
            EntityCentaur.GroupData groupdata = (EntityCentaur.GroupData)p_180482_2_1;
