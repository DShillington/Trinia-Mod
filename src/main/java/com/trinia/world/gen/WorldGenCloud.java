...
public class WorldGenCloud extends WorldGenerator {
    ...
    public WorldGenCloud() {
    	stone = TriniaBlocks.cloud.getDefaultState();
    	numberOfBlocks = 60;
                            ...
                            for(int j2 = l; j2 <= k1; ++j2) {
                                ...
                                if(d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
                                    ...
                                    if(w.getBlockState(blockpos1).getBlock().isReplaceableOreGen(w, blockpos1, this.replace)) {
                                    	w.setBlockState(new BlockPos(x, y, z), TriniaBlocks.cloud.getDefaultState(), 2);
                                    	w.setBlockState(new BlockPos(x, y - 1, z), TriniaBlocks.cloud.getDefaultState(), 2);
