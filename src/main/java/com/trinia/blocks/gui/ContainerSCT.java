...
public class ContainerSCT extends Container
{
	...
	public TileEntityTriniaWorkBench tileEntity;
    private static final String __OBFID = "CL_00001744";

    public ContainerSCT(TileEntityTriniaWorkBench tileTable, InventoryPlayer playerInventory, World worldIn, BlockPos p_i45800_3_)
    {
        this.worldObj = worldIn;
        this.field_178145_h = p_i45800_3_;
    	tileEntity = tileTable;
        this.addSlotToContainer(new slotTriniaCrafting(playerInventory.player, this.craftMatrix, tileTable.craftResult, 0, 124, 35));
        int i;
        int j;
    ...
    public ContainerSCT(InventoryPlayer playerInv, IInventory furnaceInv,
			World worldIn, BlockPos blockPosition) {
		// TODO Auto-generated constructor stub
	}

	public ContainerSCT(InventoryPlayer inventory, World world, int x, int y,
			int z) {
		// TODO Auto-generated constructor stub
	}
