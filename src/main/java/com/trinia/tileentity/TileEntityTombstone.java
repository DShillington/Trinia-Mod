...
public class TileEntityTombstone extends TileEntity
{
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            {
                return TileEntityTombstone.this.pos;
            }
            public Vec3 getPositionVector()
            {
                return new Vec3((double)TileEntityTombstone.this.pos.getX() + 0.5D, (double)TileEntityTombstone.this.pos.getY() + 0.5D, (double)TileEntityTombstone.this.pos.getZ() + 0.5D);
            }
            public World getEntityWorld()
            {
                return TileEntityTombstone.this.worldObj;
            }
            /**
    ...
    public boolean func_174882_b(final EntityPlayer playerIn)
    {
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            public void setCommandStat(CommandResultStats.Type type, int amount)
            {
                TileEntityTombstone.this.field_174883_i.func_179672_a(this, type, amount);
            }
        };
