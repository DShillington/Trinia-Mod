...
public class GuiInventorySmelter extends GuiContainer {

	// This is the resource location for the background image
	private static final ResourceLocation texture = new ResourceLocation(TriniaMod.ASSET_PREFIX, "textures/gui/smelter.png");
	private TileInventorySmelter tileEntity;

	public GuiInventorySmelter(InventoryPlayer invPlayer, TileInventorySmelter tileInventoryFurnace) {
		super(new ContainerInventorySmelter(invPlayer, tileInventoryFurnace));
