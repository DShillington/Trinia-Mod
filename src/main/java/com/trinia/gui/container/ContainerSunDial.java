...
public class ContainerSunDial extends Container
{
    ...
    private final ContainerSunDial.BeaconSlot beaconSlot;
    private static final String __OBFID = "CL_00001735";

    public ContainerSunDial(IInventory p_i45804_1_, IInventory p_i45804_2_)
    {
        this.tileBeacon = p_i45804_2_;
        this.addSlotToContainer(this.beaconSlot = new ContainerSunDial.BeaconSlot(p_i45804_2_, 0, 136, 110));
        byte b0 = 36;
        short short1 = 137;
        int i;
