 ...
 */
public class BlockTriniaSmelter extends BlockContainer
{
	public BlockTriniaSmelter()
	{
		super(Material.rock);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileInventorySmelter();
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		playerIn.openGui(TriniaMod.instance, GuiHandler.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
...
//		}
	...
	{
		TileEntity tileEntity = worldIn.getTileEntity(pos);
		if (tileEntity instanceof TileInventorySmelter) {
			TileInventorySmelter tileInventoryFurnace = (TileInventorySmelter)tileEntity;
